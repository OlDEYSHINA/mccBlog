...
namespace Blog
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine(BlogService.NumberOfCommentsPerUser(context));
            ...
            Console.WriteLine(BlogService.PostsOrderedByLastCommentDate(context));
            // Expected result (format could be different, e.g. object serialized to JSON is ok):
            // Post2: '2020-03-06', '4'
            // Post1: '2020-03-05', '8'
            // Post3: '2020-02-14', '9'
            ...
            Console.WriteLine(BlogService.NumberOfLastCommentsLeftByUser(context));
